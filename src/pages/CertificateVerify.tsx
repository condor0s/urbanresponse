...
const CertificateVerify = () => {
  // Demo data — in production these come from WordPress shortcodes
  const cert = {
        ...
        <div style={{ maxWidth: "780px", margin: "0 auto" }}>
          ...
          <div style={{
            ...
            <div style={{ padding: "56px 48px 48px", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "12px", color: "#a3a3a3", letterSpacing: "3px", textTransform: "uppercase", marginBottom: "40px" }}>
              ...
              <p style={{
                ...
                <strong style={{ color: "#1a1a1a" }}>{cert.certificate_level.split("–")[0].trim()}</strong>{" "}
                ...
                {[
                  ...
                  <div key={i}>
                    <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "4px" }}>
                      ...
                      <span style={{ fontSize: "11px", color: "#a3a3a3", textTransform: "uppercase", letterSpacing: "1px" }}>
                        {item.label}
                      </span>
                    </div>
                    <p style={{ fontSize: "14px", fontWeight: 600, color: "#1a1a1a" }}>{item.value}</p>
                  </div>
                ))}
              </div>

              {/* Footer */}
              <p style={{ fontSize: "11px", color: "#a3a3a3", letterSpacing: "1px" }}>
